define('utils/urlUtils', ['lodash'], (_) => {
  'use strict';
  ...
  return {
    ...
    getRunningExperimentsString: function(santaExperimentsObj, editorExperimentsObj, additional, current) {
      ...
      var all = _.map(additional.concat(current), exp => exp.trim());

      var experimentsObj = _.merge(santaExperimentsObj, editorExperimentsObj, (a, b) => a || b);
